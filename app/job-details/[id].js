...
const JobDetails = () => {
    ...
    const displayTabContent = () => {
        switch (activeTab) {
            ...
            case "Responsibilites":
                return <Specifics title="Responsibilites" points={data[0].job_highlights?.Qualifications ?? ['N/A']}/>
            default:
                break;
        }
    }
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: COLORS.lightWhite}}>
        ...
        />
        <>
            <ScrollView showsVerticalIndicator={false} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} />}>
                {isLoading ? (
